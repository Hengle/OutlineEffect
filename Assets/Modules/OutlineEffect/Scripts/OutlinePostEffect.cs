...
{ 
    ...
    {
        m_cacheRenderers = targetObject.GetComponentsInChildren<Renderer>();
        if (m_cacheRenderers == null || m_cacheRenderers.Length == 0)
        {
            return;
        }
        ...
        {
            m_commandBuffers.Add(targetObject, new OutlineCommandBuffer(m_cacheRenderers, m_renderTexture, new Material(m_prepassShader), color));
        }
